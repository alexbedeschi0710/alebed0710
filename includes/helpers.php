...
/* ============================================================
 *  LIVELLI - 3 FASCE
 *  Mapping serviceId Amelia → fascia di livello + range rating
 *
 *  Standard padel italiano (WPR-style):
 *   • Principiante  1.0 – 2.5
 *   • Intermedio    3.0 – 4.5
 *   • Avanzato-Pro  5.0 – 7.0+
 *
 *  NOTA: ID 7 e 8 mappano entrambi su Avanzato-Pro per sicurezza
 *  retroattiva (se ci sono partite già create con ID 8, restano valide).
 *  Puoi disabilitare il servizio ID 8 in Amelia → Services con calma.
 * ============================================================ */
